...
\begin{document}
    ...
    First place in implementation quality and technical scope of the project. \\
    ...
    Awarded for outstanding use of the Dropbox API. \\
    ...
    Second place overall, across technical complexity, business plan viability, and the minimum viable product developed over the weekend. \\
    ...
    % Iterating over activity types
        ...
        \begin{tabularx}{\tabularxwidth}{X}
            ...
            StartupUW Startup Weekend Hackathon \\
        \end{tabularx}
